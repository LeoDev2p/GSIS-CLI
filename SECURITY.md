# Security Policy - KRIPTA

## Security Commitment
KRIPTA has been designed following the MVC pattern and utilizes enterprise-grade encryption algorithms such as **Argon2id** and **Fernet (AES-256)**. However, no software is 100% invulnerable.
